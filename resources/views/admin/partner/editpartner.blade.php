    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class=" sm:mx-auto sm:w-full sm:max-w-2xl">
            <form class="space-y-3" action="{{ route('req-edit-partner',$partner->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-[#991B1B] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:text-[#dddddd] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Edit
                        Partner</button>
                </div>
            </form>
