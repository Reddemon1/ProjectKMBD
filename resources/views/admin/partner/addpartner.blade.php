<x-adminlayout>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class=" sm:mx-auto sm:w-full sm:max-w-2xl">
            <form class="space-y-3" action="{{ route('req-new-partner') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <textarea hidden rows="3" class="mb-3 d-none" name="benefit" id="benefit"></textarea>
                    @error('benefit')
                        <label class="text-red-500">{{ $message }}</label>
                    @enderror
                </div>
